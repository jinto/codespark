...
> 터미널 관리 + 프로젝트 관리 + 에이전트 오케스트레이션을 통합한다.
...
Project 기반 터미널 멀티플렉서. tmux를 대체하되, 상태가 영속적으로 보존된다.
...
Project 노트를 태스크 보드로 발전시킨다. Linear처럼 이슈를 관리하되, 터미널 세션과 연결한다.
